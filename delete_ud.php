...
<head>
     ...
     <meta charset="UTF-8" />
    <title>Delete Uddeshhya Admin</title>
								  ...
								  <div class="modal fade bs-example-modal-sm<?php echo $i; ?>" tabindex="-1" role="dialog">
									<div class="modal-dialog modal-sm">
									  <div class="modal-content">
										  ...
										  echo '<center><button class="btn btn-success btn-rounded" onclick="return(check());" name="delete" value="'.$id.'"> Delete Uddeshhya Admin</button><center>'; ?></form></div>
									  </div>
									</div>
								</div>
								  <?php
