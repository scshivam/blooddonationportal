...
<hr />
                     ...
                     <?php $i=1;
							...
							<tr>
									...
									<div class="col-lg-2"><center><?php for($k=0;$k<count($st);$k++)echo ($k+1).'. '.$st[$k].'<br>'; ?></center></div>
								  ...
								  <div class="modal fade bs-example-modal-sm<?php echo $i; ?>" tabindex="-1" role="dialog">
									<div class="modal-dialog modal-sm">
									  <div class="modal-content">
										  ...
										  for($k=0;$k<count($st);$k++)echo '<center><b>Assigned State'.($k+1).': </b> '.$st[$k].'<br><br></center>';?></div>
									  </div>
									</div>
								</div>
								  <?php
