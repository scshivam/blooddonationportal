                        ...
                        <div class="panel-heading">
							...
							$city=$cit['Taluk'];?>
                              <table class="table-striped table-hover col-lg-12" id="dataTables-example">
                                ...
                                <tbody>
								<?php $i=1;
							$query="Select Id,Name,Age,Sex,BGroup,Address,City,State,pincode,phone,Alternate,email,Detail from donor where Type='AC' AND State='$stx' AND City='$city' And Last_Donated!='Y'";
