                              ...
                              <table class="table table-striped table-hover" id="dataTables-example">
                                <thead>
                                  <tr>
									...
									<div class="col-lg-2"><center>Unassign State</center></div></th>
                                  </tr>
                                </thead>
                                <tbody>
                     <?php $i=1;
							...
							<tr>
									...
									?></center></div>
                                  <div class="col-lg-2"><center><button class="btn btn-success btn-rounded" data-toggle="modal" data-target=".bs-example-modal-sm<?php echo $i; ?>">Unassign State</button></center></div>
								  </td></tr>
									...
									<div class="modal-dialog modal-sm">
									  <div class="modal-content">
										  <div class="modal-header">
											  ...
											  <h4 class="modal-title"><?php echo $name.'(Click on Button To Unassign)'; ?></h4>
										  </div>
										  <div class="modal-body">
										  <form method="post" action="delete_unassign_state.php">
										  <?php
										  for($k=0;$k<count($st1);$k++)
								{
								$qry1="Select State_Name from state where id='$st1[$k]'";
								...
								{
								echo '<center>Click To Unassign: <button name="delete" value="'.$id.'@'.$st1[$k].'" class="btn btn-primary">'.$st[$k].'</button></center><br>';
								}
								}
										  ?></form>
										  </div>
